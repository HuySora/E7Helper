...
public static class Texture2DExtension {
    public static void DestroyIfNotNull(this Texture2D tex) {
        if (tex != null) {
            Object.Destroy(tex);
        }
    }
    ...
    public static Texture2D NewCroppedByPercent(this Texture2D srcTex, float startX, float startY, float width, float height, bool delSrc = true) {
        // Clamp values to [0,1]
        ...
        if (delSrc) srcTex.DestroyIfNotNull();
        return retTex;
    }
    ...
    public static Texture2D NewBlendMultiply(this Texture2D srcTex, Texture2D blendTex, bool delInputTex = true) {
        ...
        if (delInputTex) {
            srcTex.DestroyIfNotNull();
            blendTex.DestroyIfNotNull();
        }
        return retTex;
    }
    
    public static Texture2D NewRGB24Texture(this Texture2D srcTex, bool delSrc = true) {
